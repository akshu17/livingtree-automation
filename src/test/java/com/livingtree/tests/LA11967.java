...
public class LA11967 extends ApplicationFuncs
{	

	@Test(testName="Reporting",dataProvider="getExcelTestData",description ="Refresh design of daily-digest emails")
	public void test_LA11967(HashMap<String, String> rowMap) {
		try {
