...
public class LQ4332_VideoPost extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify the scores on commenting a post")
	public void test_LQ4332VideoPost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
