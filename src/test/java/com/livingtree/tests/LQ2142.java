...
public class LQ2142 extends ApplicationFuncs
{	

	@Test(testName="LQ2142",dataProvider="getExcelTestData",description ="Comment on District Teachers post which is made by District Admin")
	public void test_LQ2142(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
