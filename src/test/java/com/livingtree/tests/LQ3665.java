...
public class LQ3665 extends ApplicationFuncs
{	
	@Test(testName="LA_12044",dataProvider="getExcelTestData",description ="Verify recipeants in the To field if click on reply button" )
	public void test_LQ3665(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			replyMessagetouser(subject,rowMap.get("StudentOneName"));
			pause(3000);
