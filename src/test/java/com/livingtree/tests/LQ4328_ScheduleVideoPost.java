...
public class LQ4328_ScheduleVideoPost extends ApplicationFuncs
{	

	@Test(testName="LA_12190",dataProvider="getExcelTestData",description ="Verify Overall Teacher Engagement Score")
	public void test_LQ4328ScheduleVideoPost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			postScheduleVideoOnlyParents2(USERDIR+rowMap.get("VideoPath"),subject2 ,rowMap.get("Message"),rowMap.get("GroupName") );			
			logout();
