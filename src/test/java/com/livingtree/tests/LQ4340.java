...
public class LQ4340 extends ApplicationFuncs
{	

	@Test(testName="LA_12044",dataProvider="getExcelTestData",description ="Verify sent messages in Sent Messages tab")
	public void test_LQ4340(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
