...
public class LQ2744 extends ApplicationFuncs
{	
	...
	public void test_LQ2744(HashMap<String, String> rowMap){
		try {
			openLoginPage();
			
			doLogin(rowMap.get("TeacherName"),rowMap.get("Password"));
			String subject=getRandomString1(rowMap.get("eventType"));
			eventPost_with_all_option(subject,rowMap.get("location"),rowMap.get("Descrpt"));
			//Edit_calerderevent_off_allday(subject);
			logout();
