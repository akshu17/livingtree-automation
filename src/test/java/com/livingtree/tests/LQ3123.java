...
public class LQ3123 extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify after re-sahring the Post with URL, Hyperlinks and Email IDs in it")
	public void test_LQ3123(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			logout();
			doLogin(rowMap.get("Teacher"),rowMap.get("Password"));
			sharePost_group(subject, rowMap.get("GroupName"));
			logout();
