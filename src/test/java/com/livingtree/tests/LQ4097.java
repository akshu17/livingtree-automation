...
public class LQ4097 extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify ownership transfer")
	public void test_LQ4097(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			isvisibiltyafterownership(rowMap.get("GroupName"),rowMap.get("Subject"),subject,rowMap.get("Subject2"));
			pause(5000);
			logout();
			doLogin(rowMap.get("Teacher"),rowMap.get("Password"));
