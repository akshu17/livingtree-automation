...
public class LQ3664 extends ApplicationFuncs
{	
	@Test(testName="LA_12044",dataProvider="getExcelTestData",description ="Verify recipeants in the To field if click on reply all button" )
	public void test_LQ3664(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
