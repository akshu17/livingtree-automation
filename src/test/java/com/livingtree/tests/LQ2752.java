...
public class LQ2752 extends ApplicationFuncs
{	
	...
	public void test_LQ2572(HashMap<String, String> rowMap){
		try {
			openLoginPage();
			
			doLogin(rowMap.get("TeacherName"),rowMap.get("Password"));
			String subject=getRandomString1(rowMap.get("eventType"));
			eventPost_add_reminder(subject,rowMap.get("location"),rowMap.get("Descrpt"));
			Edit_calerderevent_off_reminder(subject);
			logout();
