...
public class LQ4328_ScheduleFilePost extends ApplicationFuncs
{	

	@Test(testName="LA_12190",dataProvider="getExcelTestData",description ="Verify Overall Teacher Engagement Score")
	public void test_LQ4328ScheduleFilePost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			postScheduleFileOnlyParents(USERDIR+rowMap.get("FilePath"),subject2 ,rowMap.get("Message"),rowMap.get("GroupName") );			
			logout();
