...
public class LQ4525 extends ApplicationFuncs
{	

	@Test(testName="LQ4525",dataProvider="getExcelTestData",description ="Emergencey Alert")
	public void test_LQ4525(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			doLogin(rowMap.get("Distric_admin"),rowMap.get("Password"));
			String subject=getRandomString1(rowMap.get("Subject"));
			save_default_message(subject,rowMap.get("message"));
			postEmergenceyAlert(subject,rowMap.get("message"));
