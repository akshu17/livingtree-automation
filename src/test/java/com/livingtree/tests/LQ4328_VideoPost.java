...
public class LQ4328_VideoPost extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify Overall Teacher Engagement Score")
	public void test_LQ4328VideoPost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			postVideoOnlyParents2(USERDIR+rowMap.get("VideoPath"),subject2 ,rowMap.get("Message"),rowMap.get("GroupName") );			
			logout();
