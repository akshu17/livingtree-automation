...
public class LQ4335 extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify whether Engagement coefficient (post score) is a whole number")
	public void test_LQ4335(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
