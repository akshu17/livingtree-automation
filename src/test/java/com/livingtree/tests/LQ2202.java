...
public class LQ2202 extends ApplicationFuncs
{	

	@Test(testName="LQ2202",dataProvider="getExcelTestData",description ="Verify the Sign up with Coach")
	public void test_LQ2202(HashMap<String, String> rowMap,Method method) {
		try {
			openLoginPage();
			signUp();
			adultAccount();
