...
public class LQ2230 extends ApplicationFuncs
{	

	@Test(testName="LA_12796",dataProvider="getExcelTestData",description ="Verify the TEXT  button functionality")
	public void test_LQ2230(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
