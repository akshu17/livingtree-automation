...
public class LQ4328_MessagePost extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify Overall Teacher Engagement Score")
	public void test_LQ4328MessagePost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			postMessageOnlyParents(subject2 ,rowMap.get("Message"),rowMap.get("GroupName") );			
			logout();
