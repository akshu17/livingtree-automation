...
public class LQ4668 extends ApplicationFuncs
{	

	@Test(testName="LA_13118",dataProvider="getExcelTestData",description ="User is not receiving the phone alert after removing the schedule option for a Phone alert in case of \"Scheduled Phone Alert\"")
	public void test_LQ4668(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
