...
public class LQ4819 extends ApplicationFuncs
{	

	@Test(testName="LQ4819",dataProvider="getExcelTestData",description ="Reschedule option for a schedule post during edit of a schedule post, the post still displayed as scheduled.")
	public void test_LQ4819(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			editschedulePostFileRemoveTime(subject,rowMap.get("Message"),rowMap.get("GroupName"),subjectEdit);			
			logout();
