...
public class LQ4327_ScheduleVideoPost extends ApplicationFuncs
{	

	@Test(testName="LA_12190",dataProvider="getExcelTestData",description ="Verify 'Engagement coefficient' (post score) for a post")
	public void test_LQ4327ScheduleVideoPost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
