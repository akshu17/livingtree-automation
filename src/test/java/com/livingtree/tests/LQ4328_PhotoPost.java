...
public class LQ4328_PhotoPost extends ApplicationFuncs
{	

	@Test(testName="LA_11993",dataProvider="getExcelTestData",description ="Verify Overall Teacher Engagement Score")
	public void test_LQ4328PhotoPost(HashMap<String, String> rowMap) {
		try {			
			openLoginPage();
			...
			postPhotoOnlyParents(USERDIR+rowMap.get("PhotoPath"),subject2 ,rowMap.get("Message"),rowMap.get("GroupName") );			
			logout();
