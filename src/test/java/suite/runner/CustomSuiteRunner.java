...
public class CustomSuiteRunner {
	...
	//public static void suiteRunner(HashMap<String, String> credentialsMap) {
		@BeforeTest
		...
		/*GlobalUtil.strUserName = credentialsMap.get("UserName");
		GlobalUtil.strPassword = credentialsMap.get("Password");
		GlobalUtil.strSeismicName=credentialsMap.get("SeismicName");
		GlobalUtil.strFileName=credentialsMap.get("FileName");
		System.out.println("The value of seismic name is:"+GlobalUtil.strSeismicName);*/
		...
		for (TestConfig tc : listOfTestConfigs)
		{
			...
			XmlPackage xmlpkg = new XmlPackage("com.livingtree.tests");
			...
			/*test.setClasses(validtestClasses) ;
