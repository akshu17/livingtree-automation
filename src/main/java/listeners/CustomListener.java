...
public class CustomListener extends SendMail implements ITestListener, ISuiteListener, IInvokedMethodListener 
{
    ...
    public void onFinish(ITestContext iTestContext) {
    	LogUtil.infoLog(getClass(),"Finish method " +  iTestContext.getName());
       ...
       // ExtentTestManager.endTest();
        ...
        LogUtil.infoLog(getClass(), "Report path : "+BaseMethod.HtmlReports);
		File f = new File(BaseMethod.HtmlReports);
		if (f.exists()) {

			try {
				Runtime.getRuntime()
						.exec("C:\\Program Files\\\\Google\\Chrome\\Application\\chrome.exe \"" + BaseMethod.HtmlReports
								+ "\"");
			} catch (IOException e) {
				e.printStackTrace();
			}
    ...
    public void onTestStart(ITestResult iTestResult) {
      ...
      //  System.out.println("I am in onTestStart method " +  getTestMethodName(iTestResult) + " start");
        ...
        ExtentTestManager.getTest().assignCategory( iTestResult.getMethod().getConstructorOrMethod().getMethod().getAnnotation(Test.class).testName());
        ExtentTestManager.getTest().setDescription(iTestResult.getMethod().getConstructorOrMethod().getMethod().getAnnotation(Test.class).description());
    }
...
*/
    ...
    public void onTestSkipped(ITestResult iTestResult) {
       ...
       // System.out.println("I am in onTestSkipped method "+  getTestMethodName(iTestResult) + " skipped");
        ...
        if(ConfigReader.getValue("JiraManagementTool").equalsIgnoreCase("Y")){
        	  InitMethod.jiraapi = new JiraUtil();
			InitMethod.jiraapi.updateJiraTestResults(testName, "Test Skipped", "Unexecuted");
			}
        ExtentTestManager.endTest();
