...
public class JiraUtil{
	...
	public static String USERNAME = ConfigReader.getValue("getbugToolUserName");;
	public static String PASSWORD = ConfigReader.getValue("getbugToolPassword");;
	public static String JIRA_URL = ConfigReader.getValue("getbugToolHostName");;
	public static String JIRA_PROJECT = ConfigReader.getValue("getbugToolProjectName");;
	public static String JIRA_PROJECT_ID = ConfigReader.getValue("getJiraProjectID");;
	public static String JIRA_CYCLE_ID = ConfigReader.getValue("getJiraCycleID");;
	public static String ZEPHYR_URL = ConfigReader.getValue("zephyr_url");;
	public static String ZAPI_ACCESS_KEY =ConfigReader.getValue("zapi_access_key");;
	public static String ZAPI_SECRET_KEY = ConfigReader.getValue("zapi_secret_key");;
	public static JwtGenerator jwtGenerator = null;
	...
	*/
	...
	public void updateJiraTestResults(String ExecutionID,String Comments,String Result){
		try{
			...
			/*if(ConfigReader.getValue("JiraManagementTool").equalsIgnoreCase("N")){
